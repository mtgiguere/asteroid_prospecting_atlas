...
export const PLANETS: PlanetDef[] = [
  ...
  { id: 'earth',   name: 'Earth',   sma: 1.0,   color: '#4499ff', ringAlpha: 0.6,  pointSize: 18, angleDeg: 160 },
  { id: 'mars',    name: 'Mars',    sma: 1.524, color: '#ff6644', ringAlpha: 0.45, pointSize: 13, angleDeg: 205 },
  { id: 'jupiter', name: 'Jupiter', sma: 5.203, color: '#ddbb88', ringAlpha: 0.3,  pointSize: 32, angleDeg: 75  },
]
