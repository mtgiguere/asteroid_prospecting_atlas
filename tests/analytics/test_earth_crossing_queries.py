"""
test_earth_crossing_queries.py
"""

import uuid

from asteroid_atlas.analytics.asteroid_queries import list_earth_crossing_asteroids
...
def test_list_earth_crossing_asteroids_returns_only_crossers():
    """
    Ensure only Earth-crossing asteroids are returned.
    """
    ...
    results = list_earth_crossing_asteroids(session)
